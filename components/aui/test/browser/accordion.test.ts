...
import { AccordionElement } from "../../src/accordion-element.js";
...
const defineElements = () => {
	const accordionName = `aui-accordion-${crypto.randomUUID()}`;
	const collapsibleName = `aui-collapsible-${crypto.randomUUID()}`;
