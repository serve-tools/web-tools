...
const outputPath = "/private/tmp/aui-mount-diagnostic.bundle.js";
const sha256 = (value) => createHash("sha256").update(value).digest("hex");

const bundle = await rolldown({
	input: `${root}/fixture.js`,
	resolve: { alias: { "@serve-tools/aui/checkbox": `${root}/../dist/checkbox-element.js` } },
...
if (!chunk) {
	throw new Error("AUI mount diagnostic emitted no JavaScript chunk");
}
...
await writeFile("/private/tmp/aui-mount-diagnostic.build.json", `${JSON.stringify(metadata, null, 2)}\n`);
