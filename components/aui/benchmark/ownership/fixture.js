...
const FIELD_TAG = "benchmark-aui-field";
const MENU_TAG = "benchmark-aui-menu";
const NUMBER_FIELD_TAG = "benchmark-aui-number-field";
const TOGGLE_TAG = "benchmark-aui-toggle";
...
const workloads = [
	["aui-ownership/field-mutate-replace-release", fieldLifecycle],
	["aui-ownership/toggle-mutate-replace-release", toggleLifecycle],
	["aui-ownership/number-field-mutate-replace-release", numberFieldLifecycle],
	["aui-ownership/menu-mutate-replace-release", menuLifecycle],
];

globalThis.__validateAUIOwnershipFixture = async () => {
	for (const [_name, operation] of workloads) {
		await operation();
	}
};

globalThis.__runAUIOwnershipBenchmarks = async () => {
