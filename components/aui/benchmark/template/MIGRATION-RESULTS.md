...
Under the external artifact root `aui-template-migration-2026-09-04/`, `formal-v4/results.json`, `analysis-v4.json`, `precision-v4/precision.json`, and `build-v4/manifest.json` retain exact bundles, source inputs, environment, and hashes.
...
The external artifacts `aui-template-migration-2026-09-04/weights/build-metadata.json` and `aui-template-migration-2026-09-04/size-review/README.md` document reproducible weight builds and the bounded size investigation; they do not establish a safe small change that closes the gap.
