/** The full component roster, including capabilities retained from the AUI donor. */
export const families = [
	...
	["calendar", "Calendar", "AUI capabilities"],
	["file", "File selection", "AUI capabilities"],
	["time", "Time", "AUI capabilities"],
	["drag-drop", "Drag and drop", "AUI capabilities"],
	["context", "Context", "AUI capabilities"],
	["base", "Signal layout and lifecycle", "AUI capabilities"],
] as const;
...
export function initializeGallery(): void {
	...
	const implementedCount = families.filter(
		([id, , group]) => group !== "AUI capabilities" && sections.has(id),
	).length;
