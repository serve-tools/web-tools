...
This is a native web-component contract informed by Base UI 1.7.0 and the donor AUI; it is not JavaScript API parity with either project.
...
- Donor AUI commit `080ad617486945851d0775278d1c8d215bdf75f7`, especially its option, selection, combobox, and autocomplete elements
...
<aui-autocomplete>
	...
	<div popover="manual">
		<aui-option value="jfk">John F. Kennedy International</aui-option>
	</div>
</aui-autocomplete>

<label for="service">Service</label>
<aui-combobox id="service" name="service" required>
	<input autocomplete="off">
	<div popover="manual">
		<aui-option value="pro">Professional</aui-option>
	</div>
</aui-combobox>

<label for="region">Region</label>
<aui-select id="region" name="region">
...
Host-local control, popup, filter, label, and collection observers belong to one `AUIElement` connection interval.
...
Authors who need browser-native select UI and behavior can use an ordinary `<select>` without an AUI selection owner.
