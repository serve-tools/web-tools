# AUI donor migration inventory

## Scope

This document inventories the AUI donor at `/Users/jonathan/GitHub/jsxtools/aui` revision `080ad617486945851d0775278d1c8d215bdf75f7` (`@jsxtools/aui` 0.0.13, 2025-10-13).
It records source capabilities for a future `components/aui` package and is not an implementation, compatibility promise, or release plan.
