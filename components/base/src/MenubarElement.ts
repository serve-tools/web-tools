import type { CompositeEntry } from "./_composite.js";
import { CompositeCollection, isHTMLElement, isNativelyDisabled, pathElement } from "./_composite.js";
import type { MenuHandle } from "./_menu.js";
...
export class MenubarElement extends BaseElement {
	...
	protected override connect(connection: BaseElement.Connection): void {
		...
		this.addEventListener("base-menuchange", this.#refreshFromEvent, { signal: connection.signal });
