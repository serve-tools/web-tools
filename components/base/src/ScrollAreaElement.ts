...
export class ScrollAreaElement extends BaseElement {
	#cleanups: (() => void)[] = [];
	...
	#measure(): void {
		...
		this.style.setProperty("--base-scroll-inline", `${inline}px`);
		this.style.setProperty("--base-scroll-block", `${block}px`);
		this.style.setProperty("--base-scroll-max-inline", `${maxInline}px`);
		this.style.setProperty("--base-scroll-max-block", `${maxBlock}px`);
