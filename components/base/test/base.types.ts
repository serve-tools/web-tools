...
import type { BaseElement as Base } from "@serve-tools/base-components/base";
import type { CheckboxElement as Checkbox } from "@serve-tools/base-components/checkbox";
import type { DialogElement as Dialog } from "@serve-tools/base-components/dialog";
import type { TabsElement as Tabs } from "@serve-tools/base-components/tabs";
import type { ToggleElement as Toggle } from "@serve-tools/base-components/toggle";
import type { ToggleGroupElement as ToggleGroup } from "@serve-tools/base-components/toggle-group";

const base: typeof Base = BaseElement;
