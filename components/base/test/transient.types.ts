...
import { DrawerElement, ScrollAreaElement, ToastRegionElement } from "@serve-tools/base-components";
import type {
	DrawerElement as Drawer,
	DrawerEventMap as DrawerEvents,
	DrawerSide as DrawerPlacement,
	DrawerSnapDetail as SnapDetail,
} from "@serve-tools/base-components/drawer";
import type {
	ScrollAreaElement as ScrollArea,
	ScrollAreaMetrics as ScrollMetrics,
} from "@serve-tools/base-components/scroll-area";
import type {
...
} from "@serve-tools/base-components/toast-region";
