...
import type { ToggleGroupChangeDetail } from "../../src/ToggleGroupElement.js";
import { ToggleGroupElement } from "../../src/ToggleGroupElement.js";
...
const names = (): Definitions => ({
	groupName: `base-toggle-group-${crypto.randomUUID()}`,
	toggleName: `base-toggle-member-${crypto.randomUUID()}`,
});
