...
import type { CheckboxGroupChangeDetail } from "../../src/CheckboxGroupElement.js";
...
const names = () => ({
	checkboxName: `base-checkbox-${crypto.randomUUID()}`,
	groupName: `base-checkbox-group-${crypto.randomUUID()}`,
});
