...
} from "@serve-tools/base-components/context-menu";
import type {
	MenuElement as Menu,
	MenuChangeDetail as MenuDetail,
	MenuEventMap as MenuEvents,
	MenuTarget as MenuItemTarget,
} from "@serve-tools/base-components/menu";
import type {
	MenubarElement as Menubar,
	MenubarTarget as MenubarItemTarget,
} from "@serve-tools/base-components/menubar";
import type {
	NavigationMenuElement as NavigationMenu,
	NavigationMenuTarget as NavigationTarget,
} from "@serve-tools/base-components/navigation-menu";
import type {
	ToolbarElement as Toolbar,
	ToolbarTarget as ToolbarItemTarget,
} from "@serve-tools/base-components/toolbar";
