import type { FormAssociatedElement as BarrelFormAssociatedElement } from "@serve-tools/base-components";
import type { BaseElement } from "@serve-tools/base-components/base";
...
const base: BaseElement = control;
