...
import { AccordionElement, CollapsibleElement } from "@serve-tools/base-components";
import type { AccordionElement as Accordion } from "@serve-tools/base-components/accordion";
import type { CollapsibleElement as Collapsible } from "@serve-tools/base-components/collapsible";
