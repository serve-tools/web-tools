...
This suite compares the frozen pre-migration public renderer with the final public `html` plus `BaseElement.layout()` return path.
...
The candidate counter uses the public owner-free `html\`...\``tag and returns its`TemplateResult`from`layout()`;`BaseElement` creates and owns the fragment.
...
Build Base and Signal DOM before building the fixture.
Smoke and weight checks are not formal timing and may run before the quiet slot.

```sh
node components/base/benchmark/template/build.mjs \
  --baseline-manifest /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/baseline/template/manifest.json \
  --output-dir /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/build-v4

node components/base/benchmark/template/run.mjs \
  --smoke \
  --build /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/build-v4/manifest.json \
  --output-dir /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/smoke-v4

node components/base/benchmark/template/run.mjs \
  --precision \
  --build /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/build-v4/manifest.json \
  --output-dir /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/precision-v4

node components/base/benchmark/template/weight.mjs \
  --baseline-distribution /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/baseline/distribution \
  --historical-artifact /Users/jonathan/Documents/Codex/outputs/aui-comparison-aggregate-2026-08-28 \
  --output-directory /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/weights
```
...
node components/base/benchmark/template/run.mjs \
  ...
  --build /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/build-v4/manifest.json \
  --output-dir /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/formal-v4

node components/base/benchmark/template/analyze.mjs \
  /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/formal-v4/results.json \
  --output /Users/jonathan/Documents/Codex/outputs/aui-template-migration-2026-09-04/analysis.json
```

## Corrected Base versus Base UI mount comparison

The preserved aggregate Checkbox acceptance harness is not suitable for a new mount claim as written.
Both preserved mount paths capture their duration before full semantic validation, but they still perform that validation after every mount; prior diagnostics showed that repeated full validation changes later Base mount measurements.
...
It rebuilds the exact preserved one-checkbox input against both the frozen Base distribution and the current candidate, plus Base UI and native React from the pinned closure.
The fixed raw-minified target remains Base UI's 14,477-byte increment over native React.
The candidate-minus-baseline Base delta reports the shipped cost of the public API and migrated Checkbox together; it cannot attribute bytes to a single internal helper.
