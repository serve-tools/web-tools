...
The same current BaseElement and binding-scope implementation served all three conditions.
...
The mount workload is a simple template-backed counter, not the full Base Checkbox or a Base UI component comparison.
...
Separately rebuilding the exact preserved one-checkbox application fixtures with Rolldown 1.2.7 produced Base at 17,278 raw bytes, Base UI plus React at 205,515, and native React at 191,039.
The resulting Base UI increment is 14,476 bytes; the original fixed target remains 14,477 bytes from Rolldown 1.2.6.
Base remains 2,801 bytes above that fixed target.
...
- The complete Base browser suite passed: 1,754 tests and one skipped test across Chromium, Firefox, and WebKit, including 60 new differential/mechanism checks.
- Base package typechecking and standalone strict checking of the prototype fixture passed.
...
Artifacts: `/Users/jonathan/Documents/Codex/outputs/aui-template-prototype-2026-09-04`.
