...
This proof tests whether Base can keep a native button as the authored interaction surface while coordinating pressed state across custom-element boundaries.
...
- Donor Base commit `080ad617486945851d0775278d1c8d215bdf75f7`, especially `src/mixins/toggle-mixin.ts` and `src/mixins/toggle-group-mixin.ts`
