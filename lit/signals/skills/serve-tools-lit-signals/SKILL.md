...
description: Use @serve-tools/lit-signals for lifecycle-aware Signal bindings, directives, decorators, and Lit elements.
---
...
- To apply instance host styles, read [Apply instance host styles](references/apply-instance-host-styles.md).
- To preserve lifecycle and runtime identity, read [Preserve lifecycle and runtime identity](references/preserve-lifecycle-and-runtime-identity.md).
