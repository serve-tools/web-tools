...
import { listen, type SchemaType, type SharedDBServer } from "../src/scope/shared-worker.js";
...
const server: SharedDBServer<Schema> = listen<Schema>("app", {
	version: 1,
	upgrade(database) {
...
export type ServerSchemaIsPreserved = [
	Expect<Equal<SchemaType<typeof server>, Schema>>,
	Expect<Equal<listen.SchemaType<typeof server>, Schema>>,
];
