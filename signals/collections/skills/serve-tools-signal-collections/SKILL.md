...
description: Use @serve-tools/signal-collections for shallow, fine-grained reactive Array, Map, Set, and Object APIs.
---
...
- To render collections with lit, read [Render collections with Lit](references/render-collections-with-lit.md).
