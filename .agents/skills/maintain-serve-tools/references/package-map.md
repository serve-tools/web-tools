...
Load only the Skill for the affected public package.
...
| `client/event-source`                | `client/event-source/skills/serve-tools-client-event-source/SKILL.md`                        |
| `client/http-stream`                 | `client/http-stream/skills/serve-tools-client-http-stream/SKILL.md`                          |
...
| `client/realtime`                    | `client/realtime/skills/serve-tools-client-realtime/SKILL.md`                                |
| `client/shared-db`                   | `client/shared-db/skills/serve-tools-client-shared-db/SKILL.md`                              |
| `client/shared-event-source`         | `client/shared-event-source/skills/serve-tools-client-shared-event-source/SKILL.md`          |
| `client/shared-http-stream`          | `client/shared-http-stream/skills/serve-tools-client-shared-http-stream/SKILL.md`            |
| `client/shared-websocket`            | `client/shared-websocket/skills/serve-tools-client-shared-websocket/SKILL.md`                |
| `client/shared-webtransport`         | `client/shared-webtransport/skills/serve-tools-client-shared-webtransport/SKILL.md`          |
...
| `client/webtransport`                | `client/webtransport/skills/serve-tools-client-webtransport/SKILL.md`                        |
| `client-signals/client-signals`      | `client-signals/client-signals/skills/serve-tools-client-signals/SKILL.md`                   |
| `client-signals/db`                  | `client-signals/db/skills/serve-tools-signal-db/SKILL.md`                                    |
...
| `client-signals/event-source`        | `client-signals/event-source/skills/serve-tools-signal-event-source/SKILL.md`                |
| `client-signals/http-stream`         | `client-signals/http-stream/skills/serve-tools-signal-http-stream/SKILL.md`                  |
...
| `client-signals/shared-event-source` | `client-signals/shared-event-source/skills/serve-tools-signal-shared-event-source/SKILL.md`  |
| `client-signals/shared-http-stream`  | `client-signals/shared-http-stream/skills/serve-tools-signal-shared-http-stream/SKILL.md`    |
| `client-signals/shared-websocket`    | `client-signals/shared-websocket/skills/serve-tools-signal-shared-websocket/SKILL.md`        |
| `client-signals/shared-webtransport` | `client-signals/shared-webtransport/skills/serve-tools-signal-shared-webtransport/SKILL.md`  |
...
| `server/webtransport`                | `server/webtransport/skills/serve-tools-server-webtransport/SKILL.md`                        |
