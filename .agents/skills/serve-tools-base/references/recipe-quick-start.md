...
This public-import example is generated from the compile-checked `test/base.recipes.ts` fixture in the package source.

```ts
import { createFragment, html } from "@serve-tools/base-components/template";
import { Signal } from "@serve-tools/signal";
import { BaseElement, CheckboxElement } from "@serve-tools/base-components";
...
// Opt-in persistent templates do not use BaseElement's disconnect/suspend lifecycle.
