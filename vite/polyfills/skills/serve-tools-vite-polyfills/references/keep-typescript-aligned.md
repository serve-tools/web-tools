...
- Use `@serve-tools/vite-polyfills/types/observable` for `Observable`, `Subscriber`, and `EventTarget.prototype.when`.
- Use `@serve-tools/vite-polyfills/types/composites` for the global `Composite` factory and its value type.
