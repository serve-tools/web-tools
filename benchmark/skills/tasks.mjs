...
const usageTasks = [
	usage(
		...
		["recipe-model-named-operations.md", "recipe-own-a-connection.md", "recipe-cancel-a-request.md"],
	),
	usage(
		...
		["model-the-protocol.md", "implement-handlers.md", "close-every-owned-resource.md"],
	),
	usage(
		...
		["preserve-observation-semantics.md", "respect-the-environment.md"],
	),
	usage(
		...
		["choose-occurrences-or-state.md", "own-the-lifecycle.md"],
	),
	usage(
		"lit-signal-counter",
		"Create a custom Lit counter element backed by Signal.State. Bind the count through the package's fine-grained template helper and update it from a click handler.",
		["@serve-tools/lit-signals"],
		"lit/signals/test/lit-signals.recipes.ts",
		["extends LitElement", "new Signal.State", "html`", "watch("],
		["choose-the-update-boundary.md", "compose-fine-grained-and-component-updates.md"],
	),
	usage(
		"reactive-map-filter",
		...
		["choose-the-native-shaped-collection.md", "preserve-native-and-reactive-semantics.md"],
		["@serve-tools/signal"],
	),
	usage(
		...
		["choose-immediate-or-dormant-startup.md", "preserve-scheduling-semantics.md"],
		["@serve-tools/signal"],
	),
	usage(
		...
		["configure-the-plugin.md", "design-detection-and-runtime-together.md"],
	),
];
